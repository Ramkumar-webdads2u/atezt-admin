  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <button
          type="button"
          className="relative focus:ring-none focus:outline-hidden md:h-8 md:w-8 md:bg-secondary  text-secondary-foreground   rounded-full  flex flex-col items-center justify-center cursor-pointer"
        >
      ...
      >
        <SheetHeader className="flex-none items-start space-y-1 border-b border-default-100 px-6 py-4">
          <SheetTitle className="text-xl text-default-900 font-medium">
            Cart
          </SheetTitle>
        ...
        <SheetFooter className="flex-none block border-t border-default-100 p-6">
          <div className="flex">
            <div className="flex-1  text-base font-medium leading-none text-default-900">
              Subtotal
            </div>
            <div className="flex-none text-base font-medium leading-none text-default-900">
              $0
            </div>
          </div>
