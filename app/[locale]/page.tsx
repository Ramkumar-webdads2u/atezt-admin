...
//                     Sign in to your account to start using ATEZT
//                   </div>
//                 </div>
//                 <LoginForm />
...
const Login = () => {
  return (
    <>
      <div className="flex w-full items-center overflow-hidden min-h-dvh h-dvh basis-full">
        <div className="overflow-y-auto flex flex-wrap w-full h-dvh">
          <div className="lg:block hidden flex-1 overflow-hidden bg-black relative">
            {/* Top: Logo */}
            ...
            {/* Middle: Centered GIF */}
            <div className="relative w-full h-132.5 flex justify-center items-center">
              {/* <Image
                src="https://res.cloudinary.com/nexcodez/image/upload/v1756100264/hero.webp"
                alt="login-gif"
                priority
                fill
          ...
          <div className="flex-1 relative">
            <div className=" h-full flex flex-col  dark:bg-default-100 bg-white">
              <div className="max-w-131 md:px-10.5 md:py-11 p-7  mx-auto w-full text-2xl text-default-900  mb-3 h-full flex flex-col justify-center">
                <div className="flex justify-center items-center text-center mb-6 lg:hidden ">
                  <Link href="/">
                    <Logo />
                  </Link>
